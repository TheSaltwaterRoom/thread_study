...
public:
    XTask()
    {
        std::cout << "XTask constructor this = " << this << std::endl;
    }

    virtual ~XTask()
    {
        std::cout << "XTask destructor this = " << this << std::endl;
    }

    XTask(const XTask& other)
        : is_exit(other.is_exit)
    {
        std::cout << "XTask copy constructor this = " << this
            << ", other = " << &other << std::endl;
    }

    XTask& operator=(const XTask& other)
    {
        std::cout << "XTask copy assignment operator this = " << this
            << ", other = " << &other << std::endl;
